 ...
 *
 * profile_Yuxuan_iteration_emxutil.c
 *
...
void emxFreeMatrix_cell_wrap_66(cell_wrap_66 pMatrix[2])
{
  int i;
  for (i = 0; i < 2; i++) {
    emxFreeStruct_cell_wrap_66(&pMatrix[i]);
  }
}

void emxFreeStruct_cell_wrap_66(cell_wrap_66 *pStruct)
{
...
void emxInitMatrix_cell_wrap_66(cell_wrap_66 pMatrix[2])
{
  int i;
  for (i = 0; i < 2; i++) {
    emxInitStruct_cell_wrap_66(&pMatrix[i]);
  }
}

void emxInitStruct_cell_wrap_66(cell_wrap_66 *pStruct)
{
...
/* End of code generation (profile_Yuxuan_iteration_emxutil.c) */
